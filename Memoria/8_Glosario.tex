...
\begin{description}[labelwidth=1cm, leftmargin=1.2cm]
    ...
    \item[OpenC2X:]
    Framework de comunicaciones V2X de código abierto empleado para simular servicios ITS-G5. En este Trabajo Final de Máster se adapta a Ubuntu 24.04 y se amplía para integrar SUMO mediante TraCI.
