...
struct GpsConfig {
	...
	void loadConfig() {
		...
		mMode = pt.get("gps.simulationMode", 2);
		// init saul
		// mSimConFile = pt.get("system.simConFile", "/home/saul/TFM/sumo_v2v/sumo/two_vehicles.rou.xml");
		mSimConFile = pt.get("system.simConFile", "/home/saul/TFM/sumo_v2i/sumo/ruta_coche.xml.rou.xml");
		// end saul
...
public:
	...
	void simulateFromSumo(const boost::system::error_code& ec);
...
private:
	...
	SumoInterface* m_sumoInterface = nullptr;
	CommunicationSender* m_triggerSender = nullptr;
